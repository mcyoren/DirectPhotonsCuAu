...
void get_Ntag_uncorr_sim(int num = 100, const char *inFile = "/phenix/plhf/tongzhouguo/test_tree2/trees", const char *outFile = "sim_2d_04.root", const int system = 0, int iter = 0)
{
